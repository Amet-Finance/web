export default function SubmitSVG({color, onClick}: { color?: string, onClick?: () => any }) {
    return <>
        <svg width={24} height={24} viewBox="0 0 1024 1024" className="cursor-pointer" version="1.1"
             onClick={onClick}
