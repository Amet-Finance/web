...
export default function TopAnnouncement() {
    ...
    return <>
        <div className='flex justify-between items-center w-full py-2 bg-green-500 px-4 text-black'>
            <span/>
            <span>Exciting News: Amet Finance v2 is on the Horizon! Be a part of the journey – join our discussion on <Link href={URLS.Discord} className='font-semibold' target="_blank"><u>Discord now</u></Link>.</span>
