...
const STATISTICS_DEFINITION = {
    BondScore: {
        text: "A 1-10 rating calculated using a formula that factors in the secured percentage of interest, asset verification status, and the yield rate. It provides a quick assessment of the bond's quality."
    },
    SecuredPercentage: {
