const TagTexts = {
    ...
    GitcoinPassport: "Leverage Gitcoin Passport for enhanced security and trust. This integration verifies user identities, ensuring a secure and authentic experience on Amet Finance."
}
