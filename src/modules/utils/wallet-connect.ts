...
import {bsc, manta, optimism, polygon, polygonZkEvm, zetachainAthensTestnet} from 'wagmi/chains';
...
const CHAINS = [manta, polygon, optimism, polygonZkEvm, zetachainAthensTestnet, bsc]
